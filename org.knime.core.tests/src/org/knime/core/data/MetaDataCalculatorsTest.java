 ...
 */
public class MetaDataCalculatorsTest {
    ...
    private static final TestMetaData INITIAL_META_DATA = new TestMetaData(INITIAL_VALUES);
    ...
    public void testDropWithoutCreateSingleton() {
        MetaDataCalculator first =
            MetaDataCalculators.createCalculator(createColSpec("first", StringCell.TYPE), true, false);
        MetaDataCalculator second =
            MetaDataCalculators.createCalculator(createColSpec("second", StringCell.TYPE), true, false);
    ...
    private static MetaDataCalculator createMdc(final boolean drop, final boolean create) {
        ...
        return MetaDataCalculators.createCalculator(csc.createSpec(), drop, create);
    }
    ...
    public void testDropCreate() {
        ...
        testMetaDataCalculator(mdc, Collections.singletonList(new TestMetaData(TEST_VALUES)));
    }
    ...
    public void testNoDropCreate() {
        ...
        testMetaDataCalculator(mdc, Collections.singletonList(new TestMetaData(concat)));
    }
    ...
    public void testCopy() {
        ...
        assertEquals(dropNoCreate, MetaDataCalculators.copy(dropNoCreate));

        final MetaDataCalculator noDropCreate = createMdc(false, true);
        final MetaDataCalculator copy = MetaDataCalculators.copy(noDropCreate);
    ...
    public void testMerge() {
        ...
        MetaDataCalculators.merge(dropCreate, noDropNoCreate);
        assertEquals(Collections.singletonList(new TestMetaData(concat)), dropCreate.createMetaData());
    }
    ...
    private static void testMetaDataCalculator(final MetaDataCalculator mdc, final List<MetaData> expected) {
        feed(mdc);
