...
public final class TestMetaData implements MetaData {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof TestMetaData) {
            return m_metaData.equals(((TestMetaData)obj).m_metaData);
        }
        return false;
    }
     ...
     * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
     */
    public static final class TestMetaDataCreator implements MetaDataCreator<TestMetaData> {
     ...
     * @author Adrian Nembach, KNIME GmbH, Konstanz, Germany
     */
    public static final class TestMetaDataCreatorFactory implements MetaDataCreatorFactory<TestMetaData> {
         ...
         */
        @Override
        public MetaDataCreator<TestMetaData> create() {
