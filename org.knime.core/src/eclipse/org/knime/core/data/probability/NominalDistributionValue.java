...
/**
 * Special interface that is implemented by {@link DataCell DataCells} that represent probability distributions over nominal values.
 * These distributions share the properties that the probabilites are non-negative and sum up to 1.
 *
...
public interface NominalDistributionValue extends DataValue {
    ...
    /**
     * Returns the probability of {@link DataCell value} in this distribution.
     * Note that unknown values will not result in a failure but just return a probability of 0.
     *
